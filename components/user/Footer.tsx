        ...
        <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-12 lg:gap-8">
          ...
          <div className="pr-0 lg:col-span-4 lg:pr-8">
            ...
            <div className="flex items-center gap-4">
              <Link
                ...
                className="flex h-10 w-10 items-center justify-center rounded-full border border-slate-200 bg-slate-50 text-text-muted shadow-sm transition-all hover:border-brand-base hover:bg-brand-base hover:text-white active:scale-95"
              >
                <Instagram size={18} />
              </Link>
              <Link
          ...
          <div className="lg:col-span-3">
            ...
            <div className="flex items-center overflow-hidden rounded-xl border border-slate-200/80 bg-slate-50 shadow-inner transition-all focus-within:ring-2 focus-within:ring-blue-500">
              ...
              />
              <button aria-label="Berlangganan" className="bg-brand-base p-3 text-white transition-colors hover:bg-brand-dark active:scale-95">
                <Send size={18} />
              </button>
            </div>
          </div>
