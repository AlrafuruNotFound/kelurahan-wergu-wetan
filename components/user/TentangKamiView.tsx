                    ...
                    <tr key={p.id} className="transition-colors hover:bg-slate-50">
                      ...
                      <td className="border-r border-slate-200 px-8 py-4 align-middle">
                        <div className="flex flex-row items-center justify-start gap-6">
                          <div className="relative flex h-[112px] w-[84px] shrink-0 items-center justify-center overflow-hidden border border-slate-200/50 bg-slate-100">
                            {p.foto ? (
                              <Image
                                src={p.foto}
                                alt={p.nama}
  ...
  return (
    ...
    >
      ...
      <div className={`flex items-center gap-5 p-4 md:p-6 ${isLurah ? "" : ""}`}>
        {/* Foto */}
        <div
          className={`relative flex shrink-0 items-center justify-center overflow-hidden rounded-xl border border-blue-100 bg-gradient-to-br from-blue-100 to-blue-50 text-blue-300 ${
