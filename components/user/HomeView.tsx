  ...
  return (
    <div className="relative min-h-screen bg-slate-50 pb-20">
          ...
          <div className="no-scrollbar flex h-full items-center justify-start gap-1 overflow-x-auto lg:justify-center">
            {subMenus.map((menu) => (
              <button
                ...
                className={`group relative flex h-full items-center justify-center border-b-[3px] px-5 text-[13px] font-bold tracking-wide whitespace-nowrap transition-all lg:px-6 lg:text-[14.5px] active:scale-95 ${
                  activeTab === menu.id
          ...
          <div className="mx-auto w-full max-w-5xl px-4 md:px-6 text-center">
            {welcome ? (
              ...
              <motion.div
                ...
                whileHover={{ y: -5 }}
                className="relative w-full overflow-hidden rounded-[2.5rem] border border-slate-100 bg-white p-8 shadow-[0_20px_60px_rgba(0,0,0,0.04)] transition-all duration-500 hover:shadow-[0_30px_80px_rgba(21,101,192,0.08)] md:p-16 lg:p-20"
              >
                ...
                <div className="absolute top-0 right-0 h-72 w-72 rounded-full bg-linear-to-br from-blue-50 to-transparent opacity-60 blur-3xl"></div>
                <div className="absolute bottom-0 left-0 h-72 w-72 rounded-full bg-linear-to-tr from-amber-50 to-transparent opacity-60 blur-3xl"></div>
                ...
                <div className="relative z-10 flex flex-col items-center text-center">
                  ...
                  <motion.div
                    ...
                    className="mb-8 flex h-16 w-16 items-center justify-center rounded-2xl bg-linear-to-br from-brand-base to-brand-dark text-white shadow-lg shadow-blue-500/30"
                  >
                  ...
                  <motion.div
                    ...
                    className="mt-14 mb-10 h-px w-24 bg-linear-to-r from-transparent via-slate-300 to-transparent"
                  />
                      ...
                      {welcome?.fotoURL ? (
                        ...
                        >
                          <Image
                            ...
                            className="pointer-events-none w-full h-auto -rotate-2 transform object-contain opacity-80"
      ...
      <div className="relative z-30 container mx-auto px-6">
        ...
        <section
          id="layanan"
          className="relative right-1/2 left-1/2 -mr-[50vw] -ml-[50vw] w-screen scroll-mt-[100px] overflow-hidden bg-white pt-16 pb-20"
        >
          {/* Bagian Atas / Header */}
          <div className="container mx-auto mb-12 flex flex-col items-start justify-between gap-8 px-6 lg:flex-row lg:items-center">
            ...
            <div className="flex max-w-xl flex-col items-start gap-6 text-left lg:items-end lg:text-right">
              ...
              <Link
                href="/layanan"
                className="group flex items-center gap-3 rounded-full border border-slate-300 px-6 py-2.5 text-[13px] font-semibold text-text-dark transition-all hover:border-[#0B132B] hover:bg-[#0B132B] hover:text-white active:scale-95 active:bg-[#0B132B] active:border-[#0B132B] active:text-white"
              >
                Selengkapnya{" "}
            ...
            <div className="no-scrollbar flex h-[60px] items-center gap-1 overflow-x-auto border-b border-slate-200 lg:gap-2">
              {layananTabsList.map((tab) => (
                <button
                  ...
                  className={`relative flex h-full items-center justify-center border-b-[3px] px-5 text-[13px] font-bold tracking-wide whitespace-nowrap transition-all outline-none lg:px-6 lg:text-[14.5px] active:scale-95 ${
                    layananTab === tab.id
            ...
            {layananTab === "umum" ? (
              <>
                ...
                <div className="absolute top-0 bottom-0 left-0 z-10 hidden w-1/2 bg-black lg:block">
                  ...
                  <div className="absolute inset-0 bg-linear-to-r from-transparent via-[#0B132B]/60 to-[#0B132B] opacity-100" />
                </div>
                ...
                <div className="relative z-20 container mx-auto py-10 lg:py-16">
                  <div className="flex w-full flex-col items-end">
                    ...
                    <div className="relative w-full lg:mr-[calc(50%-50vw)] lg:w-[calc(70%+50vw-50%)]">
                      ...
                      <div className="pointer-events-none absolute top-0 right-0 bottom-0 z-30 hidden w-32 bg-linear-to-l from-[#0B132B] via-[#0B132B]/80 to-transparent lg:block" />
                      <div
                                ...
                                <div>
                                   {svc.icon ? (
                                     ...
                                     <Image
                                       ...
                                       width={44}
                                       height={44}
                                       className={`mb-6 transition-colors duration-500 group-hover:brightness-0 group-hover:invert ${isActive ? "brightness-0 invert" : ""}`}
                                     />
                                   ) : null}
                                  <h3
          ...
          <div className="mb-16 flex flex-col items-start justify-between gap-10 lg:flex-row lg:items-center lg:gap-16">
            ...
            <div className="flex w-full flex-col items-start gap-8 md:flex-row md:items-center md:gap-12 lg:w-[65%]">
              ...
              <div className="shrink-0">
                <Link
                  href="/program"
                  className="group flex items-center gap-2 rounded-full border border-slate-300 px-6 py-2.5 text-[13px] font-medium whitespace-nowrap text-text-dark transition-all hover:border-[#0B132B] hover:bg-[#0B132B] hover:text-white md:px-7 md:py-[11px] active:scale-95 active:bg-[#0B132B] active:border-[#0B132B] active:text-white"
                >
                  Selengkapnya{" "}
                  <ArrowRight
                    size={16}
                  ...
                  <div className="grid h-full grid-cols-1 grid-rows-2 gap-4 sm:grid-cols-2 md:gap-6">
                    {bentoAgenda.slice(1, 5).map((item, index) => (
                      <motion.div
                        ...
                        className="group relative h-[250px] w-full cursor-pointer overflow-hidden rounded-[12px] lg:h-full"
                      >
                        <Image
                          src={item.image}
                          className="object-cover transition-transform duration-700 group-hover:scale-105"
                        ...
                        />
                        <div className="pointer-events-none absolute inset-x-0 bottom-0 h-3/4 bg-linear-to-t from-black/90 via-black/40 to-transparent" />
                    ...
                    >
                      ...
                      <div className="flex flex-1 flex-col">
                        ...
                        <div className="mt-auto pt-2">
                          <div className="inline-flex min-w-[150px] items-center justify-between gap-3 rounded-full border border-slate-400 px-6 py-2.5 text-[13px] font-semibold text-text-dark shadow-sm transition-all group-hover:border-[#0B132B] group-hover:bg-[#0B132B] group-hover:text-white active:scale-95 active:bg-[#0B132B] active:border-[#0B132B] active:text-white">
                            Selengkapnya{" "}
                            <ArrowRight
                              size={15}
                              className="transition-transform group-hover:translate-x-1"
