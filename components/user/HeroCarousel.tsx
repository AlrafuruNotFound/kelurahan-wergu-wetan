...
export default function HeroCarousel({
  ...
  // DEFAULT_BANNERS has been moved outside the component
  ...
  }, [activeBanners]); // Tetap pantau 'activeBanners' (karena DEFAULT_BANNERS sudah di luar)
  ...
  return (
    ...
    <div className="group relative h-[calc(100dvh+100px)] md:h-[calc(100vh+100px)] md:min-h-[700px] w-full overflow-hidden bg-text-dark">
      ...
      <AnimatePresence mode="wait" initial={false}>
        ...
        >
          <Image
            src={currentBanner.gambarURL}
            alt={currentBanner.judul || "Banner Kelurahan Wergu Wetan"}
            fill
            priority
            sizes="100vw"
            className="object-cover"
          />
          <div className="absolute inset-0 bg-black/50 bg-linear-to-t from-black/90 via-transparent to-black/30 md:bg-black/40" />
        </motion.div>
      </AnimatePresence>
      ...
      {activeBanners.length > 1 && (
        <div className="pointer-events-none absolute right-0 bottom-0 left-0 z-30 bg-linear-to-t from-black/80 to-transparent pt-12 pb-10 md:pb-6">
          <div className="pointer-events-auto container mx-auto px-4 md:px-6">
