              ...
              <div className="flex flex-wrap gap-2.5">
                {listLayanan.map((layanan) => (
                  <button
                    ...
                    className="rounded-full border border-slate-200 bg-white px-4 py-2 text-[13px] font-bold text-brand-base transition-all hover:scale-105 hover:border-blue-300 hover:bg-blue-50 hover:shadow-md active:scale-95 active:bg-blue-50 active:border-blue-300"
                  >
                    {layanan.name}
                  </button>
                ))}
