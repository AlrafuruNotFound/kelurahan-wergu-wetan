        ...
        >
          ...
          <div className="mt-16 flex items-center justify-between border-t border-slate-200 pt-8">
            ...
            <div className="flex gap-4">
              <button className="text-sm font-medium text-text-muted transition-colors hover:text-brand-base active:scale-95">
                Facebook
              </button>
              <button className="text-sm font-medium text-text-muted transition-colors hover:text-blue-400 active:scale-95">
                Twitter
              </button>
              <button className="text-sm font-medium text-text-muted transition-colors hover:text-green-600 active:scale-95">
                WhatsApp
              </button>
            </div>
          </div>
