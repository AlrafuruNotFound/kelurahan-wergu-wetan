          ...
          <div className="no-scrollbar flex h-full items-center justify-start gap-1 overflow-x-auto md:justify-center">
            {categories.map((cat) => (
              <button
                ...
                className={`group relative flex h-full items-center gap-2 border-b-[3px] px-6 text-[13px] font-bold whitespace-nowrap transition-all md:text-sm active:scale-95 ${
                  activeCategory === cat
        ...
        {filteredData.length === 0 ? (
          ...
          <div className="flex flex-col">
            ...
            <div className="mt-14 flex flex-wrap items-center justify-center gap-2">
              <button className="flex h-[42px] w-[42px] items-center justify-center bg-brand-base text-[15px] text-white transition-colors active:scale-95">
                1
              </button>
              {[2, 3, 4, 5, 6, 7, 8, 9, 10].map((num) => (
                <button
                  key={num}
                  className="flex h-[42px] w-[42px] items-center justify-center border border-slate-200 bg-white text-[15px] text-text-muted transition-all duration-300 hover:-translate-y-1 hover:border-brand-base hover:bg-brand-base/90 hover:text-white hover:shadow-md active:scale-95"
                >
                  {num}
                </button>
              ))}
              <button className="flex h-[42px] items-center justify-center border border-slate-200 bg-white px-5 text-[15px] text-text-muted transition-all duration-300 hover:-translate-y-1 hover:border-brand-base hover:bg-brand-base/90 hover:text-white hover:shadow-md active:scale-95">
                Next
              </button>
            </div>
          </div>
