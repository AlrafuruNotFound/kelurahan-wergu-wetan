            ...
            >
              ...
              {activeTag === "Semua" && (
                <>
                  ...
                  {/* "MORE" BUTTON */}
                  {filtered.length > 4 && (
                    <div className="mb-6 flex w-full justify-center bg-brand-base py-[14px] transition-all hover:bg-blue-800 active:scale-[0.98] active:bg-blue-900">
...
<div className="mt-14 mb-10 flex flex-wrap items-center justify-center gap-2">
  <button
    aria-label="Page 1"
    className="flex h-[42px] w-[42px] items-center justify-center bg-brand-base text-[15px] text-white transition-colors"
  >
    1
  </button>
  {[2, 3, 4, 5, 6].map((num) => (
    <button
      key={num}
      aria-label={`Page ${num}`}
      className="flex h-[42px] w-[42px] items-center justify-center border border-slate-200 bg-white text-[15px] text-text-muted transition-all duration-300 hover:-translate-y-1 hover:border-brand-base hover:bg-brand-base/90 hover:text-white hover:shadow-md active:scale-95 active:bg-brand-base active:text-white active:border-brand-base"
    >
      {num}
    </button>
  ))}
  <button
    ...
    className="flex h-[42px] items-center justify-center border border-slate-200 bg-white px-5 text-[15px] text-text-muted transition-all duration-300 hover:-translate-y-1 hover:border-brand-base hover:bg-brand-base/90 hover:text-white hover:shadow-md active:scale-95 active:bg-brand-base active:text-white active:border-brand-base"
  >
    Next
  </button>
</div>
