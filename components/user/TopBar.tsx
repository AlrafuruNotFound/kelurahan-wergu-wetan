...
export default function TopBar() {
  ...
  return (
    <div className="relative z-60 flex h-[40px] items-center bg-text-dark text-[11px] text-slate-300 transition-all md:text-xs">
              ...
              <>
                ...
                <div className="absolute top-full right-0 z-50 mt-2 w-20 rounded-lg border border-slate-200 bg-white py-1 text-text-dark shadow-xl">
                  {["ID", "EN", "JW"].map((code) => (
                    <button
                      key={code}
                      onClick={() => handleLangChange(code as "ID" | "EN" | "JW")}
