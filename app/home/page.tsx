...
export default async function HomePage() {
  ...
  const tentangKamiBanner =
    (await prisma.bannerHomepage.findFirst({
  ...
  const agenda = [
    {
      id: 1,
      title: "Laporan Keterangan Pertanggungjawaban (LKPJ) Tahun 2024",
      date: "25 Oktober 2025",
      lokasi: "Kantor Kelurahan",
    },
    {
      id: 2,
      title: "Rencana Pembangunan Jangka Menengah Kelurahan",
      date: "01 Januari 2026",
      lokasi: "Aula Pertemuan",
    },
    {
      id: 3,
      title: "Realisasi Program Pemberdayaan UMKM Lokal",
      date: "15 November 2025",
      lokasi: "Area Wergu Wetan",
    },
  ];
